...
describe Cask::CLI::Linkapps do
  ...
  it "only links casks mentioned when arguments are provided" do
    ...
    TestHelper.is_alias?(Cask.appdir/"Transmission.app").must_equal true
    TestHelper.is_alias?(Cask.appdir/"Caffeine.app").wont_equal true
  end
  ...
  it "links all installed casks when no arguments supplied" do
    ...
    TestHelper.is_alias?(Cask.appdir/"Transmission.app").must_equal true
    TestHelper.is_alias?(Cask.appdir/"Caffeine.app").must_equal true
  end
end
